...
for i = 1:num_samples
    fill(t_pulses{i,1}, natural_pulses{i}, [1 0.5 0], 'FaceAlpha', 0.3, 'EdgeColor', 'none', 'DisplayName', 'PAM Natural');
end

for i = 1:num_samples
    line(t_pulses{i,2}, instant_pulses{i}, 'Color', [1 0 0], 'LineWidth', 1.2, 'DisplayName', 'PAM Instantáneo');
end
